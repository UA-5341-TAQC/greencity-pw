...
- Name: tc-3-successful-user-registration.spec.ts >> User Registration >> TC-3 Verify successful user registration with valid credentials
- Location: tests/tc-3-successful-user-registration.spec.ts:5:3
