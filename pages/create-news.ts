...
export class CreateNewsPage extends BasePage {
  ...
  protected readonly contentEditorСounter: Locator;
  ...
  constructor(page: Page) {
    ...
    this.newsTag = page.locator("div.tags-box button.tag-button:has-text('News')");
    this.eventTag = page.locator("div.tags-box button.tag-button:has-text('Event')");
    this.educationTag = page.locator("div.tags-box button.tag-button:has-text('Education')");
    this.initiativesTag = page.locator("div.tags-box button.tag-button:has-text('Initiatives')");
    this.adsTag = page.locator("div.tags-box button.tag-button:has-text('Ads')");
    ...
    this.contentEditorСounter = page.locator('p.quill-counter.warning');
  ...
  async getContentEditorCounter(): Promise<string> {
    return (await this.contentEditorСounter.textContent()) ?? '';
  }
